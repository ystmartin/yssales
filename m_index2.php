...
<body>
    ...
    <tbody>
        ...
        <div class="pc_head01_1">
            ...
            echo '<div class="row">';
            echo    '<div><form name="form1" method="post" action="pc_index.php">';
            ...
            echo "<div class='col-3 item'><a href='pc_logout.php?'><font color='white'><h7>登出</h7></font></a></div>";
            //echo '<div class="col-sm-1 item"></div>';
            echo '</div>';
            ?>
        ...
        <div class="pc_head02 container-fluid">
            ...
            <div class="pc_head02_1 row">
                ...
                echo "<div class='col-3 item'><a href='pc_cookie.php?check01=" . $key01 . "'><font color=" . $chkcolor01 . "><h6>" . $check01 . "</h6></font></a></div>";
                echo "<div class='col-3 item'><a href='pc_cookie.php?check02=" . $key02 . "'><font color=" . $chkcolor02 . "><h6>" . $check02 . "</h6></font></a></div>";
                echo "<div class='col-3 item'><a href='pc_cookie.php?check03=" . $key03 . "'><font color=" . $chkcolor03 . "><h6>" . $check03 . "</h6></font></a></div>";
                echo "<div class='col-3 item'><a href='pc_cookie.php?check04=" . $key04 . "'><font color=" . $chkcolor04 . "><h6>" . $check04 . "</h6></font></a></div>";
                //echo "<div class='col-sm-4 item'></div>";
                ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            echo '<div class="row">';
            echo '<div class="col-3 item"><a href=pc_cookie.php?route=' . 'ALL' . ' ' . 'target="_self"><h6>' . '全線' . '</h6></a></div>';
            while ($row = mysqli_fetch_assoc($result)) {
            echo '<div class="col-3 item"><a href=pc_cookie.php?route=' . $row["route"] . ' ' . 'target="_self"><h6>' . $row["route"] . '</h6></a></div>';
            }
            echo '</div>';
            ?>
        </div>
        ...
        <div class="row">
            ...
            while ($row2 = mysqli_fetch_assoc($result2)) {
                ...
                echo '<div class="col-3 item"><a href=pc_cookie.php?groupname=' . $urltemp . ' ' . 'target="_self"><h6>' . $grouptemp . '</h6></a></div>';
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th>
                        <div class="m_head04_1">出發日期 </div>
                    </th>
                    <th>
                        <div class="m_head04_1">產品名稱(外網)</div>
                    </th>
                    <th>
                        <div class="m_head04_1">直客價</div>
                    </th>
                    <th>
                        <div class="m_head04_1">可售</div>
                    </th>
                    <th>
                        <div class="m_head04_1">收訂</div>
                    </th>
                    <th>
                        <div class="m_head04_1">狀態</div>
                    </th>
                    <th>
                        <div class="m_head04_1">顯示詳情</div>
                    </th>
