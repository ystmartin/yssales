...
<body>
    ...
    <tbody>
        ...
        <div class="pc_head01_1">
            ...
            echo '<div class="row">';
            echo    '<div><form name="form1" method="post" action="m_index.php">';
            //echo  '<table border="0" width="200" align="center" cellspacing="0">';
            echo    '搜尋產品名稱關鍵字：<input type="text" name="search"><input type="submit" value="輸入">';
            //echo  '</table>';
            echo    '</form></div>';
            echo '</div>';
            echo '<div class="row">';
            //echo "<div class='col-sm-1 item'><a href='pc_account_admin.php?'><font color='white'><h6>管理</h6></font></a></div>";
            echo "<div class='col-6 item'><h7>" . '帳號：' . "$name</h7></div>";
            echo "<div class='col-3 item'><h7>" . '職務：' . "$level</h7></div>";
            echo "<div class='col-3 item'><a href='index.php?'><font color='white'><h7>登出</h7></font></a></div>";
            //echo '<div class="col-sm-1 item"></div>';
            echo '</div>';
            ?>
        ...
        <div class="pc_head02 container-fluid">
            ...
            <div class="pc_head02_1 row">
                ...
                echo "<div class='col-3 item '><a href='m_cookie.php?check01=" . $key01 . "'><font color=" . $chkcolor01 . "><h6>" . $check01 . "</h6></font></a></div>";
                echo "<div class='col-3 item'><a href='m_cookie.php?check02=" . $key02 . "'><font color=" . $chkcolor02 . "><h6>" . $check02 . "</h6></font></a></div>";
                echo "<div class='col-3 item'><a href='m_cookie.php?check03=" . $key03 . "'><font color=" . $chkcolor03 . "><h6>" . $check03 . "</h6></font></a></div>";
                echo "<div class='col-3 item'><a href='m_cookie.php?check04=" . $key04 . "'><font color=" . $chkcolor04 . "><h6>" . $check04 . "</h6></font></a></div>";
                //echo "<div class='col-sm-4 item'></div>";
                ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            echo '<div class="row">';
            echo '<div class="col-3 item"><a href=m_cookie.php?route=' . 'ALL' . ' ' . 'target="_self"><h6>' . '全線' . '</h6></a></div>';
            while ($row = mysqli_fetch_assoc($result)) {
            echo '<div class="col-3 item"><a href=m_cookie.php?route=' . $row["route"] . ' ' . 'target="_self"><h6>' . $row["route"] . '</h6></a></div>';
            }
            echo '</div>';
            ?>
        </div>
        ...
        <div class="row">
            ...
            while ($row2 = mysqli_fetch_assoc($result2)) {
                ...
                echo '<div class="col-3 item groupname"><a href=m_cookie.php?groupname=' . $urltemp . ' ' . 'target="_self"><h6>' . $grouptemp . '</h6></a></div>';
        ...
        <table class="table table-striped">
            <tbody>
                <div class="row head03_txt">
                    ...
                    if ($search != '') {
                        $sql3 = "SELECT * FROM dynamiclist where productname like '%$search%' and " . "groupname not like '%TKT'" . $team01 . $team02 . $team03 . $team04 . "order by depdate ASC";
                    }
                    //echo $sql3;
                    ...
                    if ($result3->num_rows > 0) {
                        ...
                        while ($row3 = $result3->fetch_assoc() and $j <= $records_per_page) {
                            ...
                            // echo "</tr>";
                            echo "<div>";
                            echo "<div>" ."出發日期:". $row3['depdate'] . "</div>";
                            echo "<div>" ."產品名稱:".$row3['productname'] . "</div>";
                            echo "<div>" ."直售價:". "$" . number_format($row3['customnet']) . "</div>";
                            echo "<div>" . "可售:".$row3['cansales'] . "</div>";
                            echo "<div>" . "收訂:".$row3['getdeposit'] . "</div>";
                            echo "<div>" . "狀態:".$row3['status'] . "</div>";
                            echo "<div>"."<button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#myModal" . $row3['SN'] . "'>顯示詳細</button></div>";
                            echo "</div>";
                        ...
                        while ($row3 = $result3->fetch_assoc()) {
                            ...
                            echo "<div class='modal-body lh-sm'>";
        ...
        echo "</p>";
        echo "<p align='center'>";
        echo "<a href=m_index.php?page=1>第一頁</a> ";
        for ($i = 1; $i <= $total_pages; $i++) {
            if ($page - 1 < $i && $i < $page + 1) {
                $prepage = $i - 1;
                echo "<a href=m_index.php?page=" . $prepage . ">" . "上一頁" . "</a> ";
                echo "共 " . $total_records . " 筆;目前在第--" . $i . "--頁 ;共 " . $total_pages . " 頁";
                $nextpage = $i + 1;
                echo "<a href=m_index.php?page=" . $nextpage . ">" . "下一頁" . "</a> ";
            }
        }
        echo "<a href=m_index.php?page=" . $total_pages . ">最末頁</a>";
        echo "</p>";
