...
<body>
    ...
    if($_POST["sel_date"]!=""){
        ...
        setcookie("sel_date",$_POST["sel_date"],time()+3600);
        setcookie("key01","N",time()+3600);
        setcookie("key02","N",time()+3600);
        setcookie("key03","N",time()+3600);
        setcookie("key04","N",time()+3600);
    ...
    if($_GET["sel_date"]=="clear"){
        setcookie("sel_date","",time()-3600);
    }
