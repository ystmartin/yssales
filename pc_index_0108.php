    ...
    <tbody>
        ...
        <div class="pc_head01_1 container-fluid">
            <div class="row">
                ...
                echo            '<div class="col-sm-2 item">搜尋<input type="text" name="search"><input type="submit" value="輸入"></div>';
                //echo    '</table>';
                ...
                <div class="row head03_txt">
                    ...
                    if ($result3->num_rows > 0) {
                        ...
                        while ($row3 = $result3->fetch_assoc() and $j <= $records_per_page) {
                            ...
                            echo "<td width='4%' align='right'>" . "$" . $row3['customnet'] . "</td>";
                            echo "<td width='4%' align='right'>" . "$" . $row3['agentnet'] . "</td>";
        ...
        echo '共 '.$total_records.' 筆-在 '.$page.' 頁-共 '.$total_pages.' 頁';
        echo "<br /><a href=pc_index.php?page=1>首頁</a> ";
        echo "第 ";
        for( $i=1 ; $i<=$total_pages ; $i++ ) {
        ...
        echo " 頁 <a href=pc_index.php?page=".$total_pages.">末頁</a><br /><br />";
