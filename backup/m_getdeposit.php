...
<body>
	...
	$sql = "SELECT * FROM dynamiclist where getdeposit > 0  order by depdate ASC";
	...
	echo "<th id='head01'><a href='m_getdeposit.php'>收訂</th>";
	echo "</thead>";
	echo "<thead>";
	...
	echo "<th id='head03' align='left'>團名</th>";
	echo "</thead>";
	echo "<thead>";
	...
	echo "<th id='head03' width=15%>"."<font color = 'red'>收訂數</th>";
	echo "</thead>";
	echo "<thead>";
	echo "<th id='head03' align='left' colspan='6'>員工備註</th>";
	echo "</thead>";
	echo "<tbody>";
    ...
    echo "<tr>";
    echo "<td align='left' bgcolor='$color' colspan='6'><font color=$font_color>" .$lock. $row['groupname'] . "</font></td>";
    echo "</tr>";
    echo "<tr>";
    ...
    echo "<td align='center' bgcolor='$color'  width=15%>"."<font color = 'red'>" . $row['getdeposit'] . "</font></td>";
    echo "</tr>";
    echo "<tr>";
	...
	echo "<p align='center'>";
	if ($page > 1)
		echo "<font size='28px'><a href='m_getdeposit.php?page=" . ($page - 1) . "'>上一頁</a></font>";

	for ($i = 1; $i <= $total_pages; $i++) {
		if ($i == $page)
			echo "<font size='28px'>".$i."</font> ";
		else
			echo "<font size='28px'><a href='m_getdeposit.php?page=$i'>$i</a></font> ";
	}

	if ($page < $total_pages)
		echo "<font size='28px'><a href='m_getdeposit.php?page=" . ($page + 1) . "'>下一頁</a></font> ";
